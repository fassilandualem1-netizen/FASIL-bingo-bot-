...
def verify_payment_strict(text):
    ...
    # የዕጣ ዋጋን ከዳታቤዝ መፈለግ (ከሌለ 20 ብር Default)
    try:
...
def start(message):
    ...
    try:
        ...
        bot.send_message(message.chat.id, "ሰላም! ቦቱ ንቁ ነው (ዳታቤዝ ግንኙነት እየተሞከረ ነው)።")
...
def handle_all(message):
    ...
    # --- REGISTRATION (Wallet/Multi-Ticket) ---
